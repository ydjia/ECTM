...
/*
#define		AT86RF212_RESET		GPIO_Pin_11			//PB11
#define		AT86RF212_SLP_TR	GPIO_Pin_0 		 //PB0

#define		AT86RF212_DIG2		GPIO_Pin_1			//PB1
#define		AT86RF212_IRQ		GPIO_Pin_1			//PA1

#define		AT86RF212_SEL		GPIO_Pin_4			//PA4
#define		AT86RF212_MOSI		GPIO_Pin_7			//PA7
#define		AT86RF212_MISO		GPIO_Pin_6			//PA6
#define		AT86RF212_SCK		GPIO_Pin_5		//PA5
#define		AT86RF212_CLK_M	 	//CLKM --PA0  
*/

#define		AT86RF212_ResetEn()			GPIO_ResetBits(GPIOB,GPIO_Pin_11)
#define		AT86RF212_ResetDis()		GPIO_SetBits(GPIOB,GPIO_Pin_11)

#define		AT86RF212_SLP_TRReset()		GPIO_ResetBits(GPIOB,GPIO_Pin_0)
#define		AT86RF212_SLP_TRSet()		GPIO_SetBits(GPIOB,GPIO_Pin_0)
#define 	AT86RF212_SLP_TRStatus()	GPIO_ReadOutputDataBit(GPIOB,GPIO_Pin_0)
...
#define		AT86RF212_IRQStatus()		GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_1)		//¶ÁIRQÒý½Å×´Ì¬
...
#define TempStartPos 11
#define HumidStartPos 14
